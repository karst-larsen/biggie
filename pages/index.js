...
export default function Home() {
  ...
  const sickerThanAverage = useRef();
  const bottomHero = useRef();
  const main = useRef();
 ...
 console.log("Sicker than average:", sickerThanAverage.current, "bottomHero:,", bottomHero.current);


  return (
    <div className="box-border m-0 p-0" ref={main}>
      <Head>
      ...
      <main className="box-border m-0 p-0 w-screen h-full">
        ...
        className="bg-yellow-50 flex flex-col md:flex-row items-center md:items-between text-center w-screen md:h-136">
          ...
          className="p-4 w-screen sm:w-5/6 flex flex-col justify-between items-center my-12 md:my-0 md:w-1/2 2xl:w-1/2">
            ...
            <button className="bg-yellow-400 uppercase p-4 w-36 rounded text-yellow-50 hover:bg-yellow-500">Menu</button>
          </div>
        ...
        <div className="bottomHero bg-red-800 h-1/2 w-full py-16 px-4" ref={bottomHero} id="bottomHero">
          <div className="flex flex-col justify-center items-center text-center h-72" ref={sickerThanAverage} id="sickerThanAverage"> 
        ...
        <div className="bg-yellow-50 h-fit flex justify-center ">
            ...
            <h1 className="text-5xl text-center text-red-800 font-bold py-4 border-b-4 border-red-800 mb-8">Menu</h1>
          {
            mainMenuList.map(menuItem => {
               return (
                <div className="flex flex-col justify-center items-center text-center text-red-800 mb-8 py-4" key={menuItem.item}>
                  <h2 className="text-4xl font-bold px-4">{menuItem.item}</h2>
            ...
            <div className="bg-red-800 h-fit pb-8">
              ...
              <p className="text-yellow-50 mb-8 font-light border-b-2 pb-8 text-center italic">All of our potatoes are freshly imported from Idaho.</p>
              {
            ...
            <div className="h-fit">
              ...
              <p className="border-b-2 border-red-800 text-red-800 font-light pb-8 text-center italic">Featuring collaborations with our brothers over at Tang Bakery.</p>
              {
